    ...
    return (
        <Container>
            <ScrollView>
                <Content>
                    <Text>
                        Olá, se você chegou aqui é porque descobriu um botão escondido no app e tocou nele 10x para conseguir chegar aqui 😬.{'\n\n'}
                        ...
                        {'\u2022'} <FeaturedName>Álex Oliveira:</FeaturedName> Me incentivou, me motivou e viu o app nascer do zero, me ajudou com várias sugestões no desenvolvimento, na escolha do layout e me deu impulso para continuar a sonhar com o app e fazê-lo evoluir.{'\n\n'}
                        ...
                        {'\u2022'} <FeaturedName>Marcus Del Pino:</FeaturedName> A pessoas que me ajuda com o design do app principalmente no logo e também no desenvolvimento da versão Web (isso é um spolier, então guarde em segredo hein 🙃).{'\n\n'}
                    </Text>
